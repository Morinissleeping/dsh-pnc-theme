...
- **毛玻璃层**：独立模糊层（`#pnc-bg-glass`）位于视频/图片之上、所有其他元素之下，统一对背景做毛玻璃效果（视频/图片不再自带 blur）；不透明度可在设置页调节
...
dsh plugin --profile web add https://github.com/Morinissleeping/dsh-pnc-theme/releases/download/v0.2.4/dsh-external-dsh-pnc-theme-0.2.4.tgz
