(function () {
  ...
  function applyTheme(t) {
    ...
    root.style.setProperty('--pnc-panel-alpha', String(clampNum(th.panelAlpha, 0.6, 0, 1)));
    ...
    root.style.setProperty('--pnc-glass-alpha', String(clampNum(th.glassAlpha, 0.65, 0, 1)));
