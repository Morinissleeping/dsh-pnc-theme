...
`;
		const PNC_THEME_DEFAULTS = { quotaMo: '#1550B5', quotaWk: '#3A7BF2', quotaRl: '#5E9CF5', panelAlpha: 0.9, contourAlpha: 0.15, conwayAlpha: 0.55, conwayDensity: 1.6, videoAlpha: 1, conwayRefreshMs: 620, conwayScrollMs: 30, conwayScrollBlocks: 0.005, contourFlowMs: 180000, contourRefreshMs: 0, glassAlpha: 0.25, quotaRefreshSec: 60 };
		...
		function PncQuotaSection() {
			...
			return React.createElement("div", { className: "pnc-page" },
				...
				React.createElement("p", { className: "pnc-desc" }, "毛玻璃为独立模糊层，位于背景之上、所有元素之下（全屏）；数值越高背景越模糊。"),
				...
				rangeRow("面板透度", "panelAlpha", 0, 1, 0.05, (v) => Math.round(v * 100) + "%"),
